...
def lookup_next_f1_race() -> tuple[dict[str, Any] | None, bool]:
    urls = [
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:  # noqa: N802
        ...
        if path == "/api/metadata":
            ...
            next_race, f1_live_ok = lookup_next_f1_race()
            return self._send_json({"airports": AIRPORTS, "currencies": SUPPORTED_CURRENCIES, "places": places, "f1_live": {"next_race": next_race, "live": f1_live_ok}})
    ...
    def do_POST(self) -> None:  # noqa: N802
        ...
        if path == "/api/recommendations/generate":
            ...
            context = {
                ...
                "f1_live": {"next_race": next_race, "live": f1_live_ok},
                "live_data_summary": {
