        ...
        recommendations.append(
            {
                ...
                "save_tips": [
                    "Fly mid-week and arrive Thursday before race crowds.",
                    "Stay 3-7 km from circuit and use train/metro for better value.",
                ],
                "splurge_tips": [
                    "Spend extra on race-day seat quality for the biggest experience jump.",
                    "Choose one premium add-on: paddock tour, simulator, or pit lane walk.",
                ],
            }
        )
